...
import 'package:push_app/config/local_notifications/local_notifications_config.dart';
...
void main() async {
  ...
  // Initialize Notifications Providers.
    ...
    MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => NotificationsBloc(
          requestLocalNotificationPermissions: LocalNotificationsConfig.requestPermission,
          showLocalNotification: LocalNotificationsConfig.showLocalNotification
        ))
      ],
      child: const MyApp(),
    )
