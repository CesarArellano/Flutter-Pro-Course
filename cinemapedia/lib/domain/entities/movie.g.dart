...
void _movieSerialize(
  ...
  writer.writeString(offsets[4], object.heroId);
...
Movie _movieDeserialize(
  ...
  final object = Movie(
    ...
    heroId: reader.readStringOrNull(offsets[4]),
    id: reader.readLongOrNull(offsets[5]),
    originalLanguage: reader.readStringOrNull(offsets[6]),
    originalTitle: reader.readStringOrNull(offsets[7]),
    overview: reader.readStringOrNull(offsets[8]),
    ...
    revenue: reader.readLongOrNull(offsets[12]),
    runtime: reader.readLongOrNull(offsets[13]),
    title: reader.readStringOrNull(offsets[14]),
    video: reader.readBoolOrNull(offsets[15]),
    voteAverage: reader.readDoubleOrNull(offsets[16]),
    voteCount: reader.readLongOrNull(offsets[17]),
  );
  object.isarId = id;
  return object;
}
...
extension MovieQueryFilter on QueryBuilder<Movie, Movie, QFilterCondition> {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'heroId',
      ));
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'heroId',
      ));
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'heroId',
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'heroId',
        value: '',
  ...
  QueryBuilder<Movie, Movie, QAfterFilterCondition> heroIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'heroId',
        value: '',
...
extension MovieQuerySortBy on QueryBuilder<Movie, Movie, QSortBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> sortByHeroId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'heroId', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> sortByHeroIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'heroId', Sort.desc);
    });
  }
...
extension MovieQuerySortThenBy on QueryBuilder<Movie, Movie, QSortThenBy> {
  ...
  QueryBuilder<Movie, Movie, QAfterSortBy> thenByHeroId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'heroId', Sort.asc);
    });
  }

  QueryBuilder<Movie, Movie, QAfterSortBy> thenByHeroIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'heroId', Sort.desc);
    });
  }
...
extension MovieQueryWhereDistinct on QueryBuilder<Movie, Movie, QDistinct> {
  ...
  QueryBuilder<Movie, Movie, QDistinct> distinctByHeroId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'heroId', caseSensitive: caseSensitive);
    });
  }
...
extension MovieQueryProperty on QueryBuilder<Movie, Movie, QQueryProperty> {
  ...
  QueryBuilder<Movie, String?, QQueryOperations> heroIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'heroId');
    });
  }
